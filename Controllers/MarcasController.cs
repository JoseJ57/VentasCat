...
namespace VentasSD.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public MarcasController(MyContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdMarca,Nombre,Pais")] Marca marca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMarca,Nombre,Pais")] Marca marca)
        {
            if (id != marca.IdMarca)
            {
                return NotFound();
